namespace Application
{
    public record class Result
    {
        ...
        public static Result OkWithMessage() => new(success: true, message: string.Empty);

        public static Result<T> OkWithMessage<T>(T value) => new(value: value, success: true, message: string.Empty);
